	...
	return (
        <div className={styles.contact}>
			...
			<div className={styles.links}>
					...
					<a href="https://www.behance.net/hudaasabrie" className={styles.lab} target="_blank">Behance</a>
                    <a href="mailto:hudasabrie@email.com#" className={styles.email} target="_blank">Email</a>
